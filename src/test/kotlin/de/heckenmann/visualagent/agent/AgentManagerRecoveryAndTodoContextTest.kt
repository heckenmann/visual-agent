...
class AgentManagerRecoveryAndTodoContextTest {
    ...
    @Test
    fun `main request includes current todo list in system context`() = runBlocking {
    ...
    @Test
    fun `manager resumes interrupted conversation when last message was from user`() = runBlocking {
