...
internal object UxSeedTasks {
    ...
    fun all(): List<String> =
        listOf(
            ...
            "Compose shell: persistent left navigation with active state and tooltips",
            "Compose shell: command palette (Cmd/Ctrl+K) to switch panels/search",
            ...
            "Compose canvas: toolbar (pen, eraser, undo/redo, export)",
            "Compose canvas: pan/zoom, grid, snapshots saving",
