...
/**
 * Verifies that [OllamaToollessChat] strips top-level keys (`model`, `format`,
 * `keep_alive`, `truncate`) from the `options` map before placing them into the
 * [OllamaApi.ChatRequest] record, because these fields belong at the top level
 * of the Ollama API request body.
 */
