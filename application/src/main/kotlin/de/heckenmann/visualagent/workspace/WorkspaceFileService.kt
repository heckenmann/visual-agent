...
class WorkspaceFileService
    ...
    constructor(
        ...
        constructor(
            ...
            databasePath: String,
            mimeDetector: WorkspaceMimeTypeDetector = WorkspaceMimeTypeDetector(),
            activityEvents: WorkspaceFileActivityEventBus? = null,
         ...
         */
        fun workspaceRoot(): Path = WorkspaceFilePaths.workspaceRoot(serverDataRoot)

        /** Lists all workspace-relative directories, including empty directories. */
        fun listDirectories(): List<String> = listWorkspaceDirectories(workspaceRoot())
        ...
        internal fun recordManagedFile(
            ...
            val now = Instant.now()
            val relativePath = WorkspaceFilePaths.relativePath(destination, workspaceRoot())
         ...
         */
        fun resolveManagedPath(relativePath: String): Path = WorkspaceFilePaths.resolveManagedPath(relativePath, workspaceRoot())
